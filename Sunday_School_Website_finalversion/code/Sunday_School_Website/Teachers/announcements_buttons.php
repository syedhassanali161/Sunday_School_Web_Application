...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Select A Class - Announcements</title>
  ...
  <body>
    ...
    if ($_SESSION["show"] == true) {
      ...
      while ($row = mysqli_fetch_assoc($result)) { //creating an associative array variable, $row, for every row fetched by the query
        echo "<form action='announcements_buttons-inc.php' method='post'>";
